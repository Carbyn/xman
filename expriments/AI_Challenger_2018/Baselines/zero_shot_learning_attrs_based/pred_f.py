...
def main(superclass, model_weight, img_path, model=None):
    ...
    attrs_list_path = '../zsl_b_%s_train_%s/zsl_b_%s_train_annotations_attribute_list_%s.txt' % (superclass.lower(), date, superclass.lower(), date)
    test_dir= '../zsl_b_%s_test_%s/' % (superclass.lower(), date)
