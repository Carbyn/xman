    ...
    def window_reader():
        ...
        for video in database.keys():
            ...
            try:
                ...
                continue
            for pos in range(0, (np.shape(video_fea)[0] - window_len), window_len):
                label = getLabel(video, pos, pos+window_len, data_type) 
